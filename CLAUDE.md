...
Found during the Circle confirm-descriptor sweep on `feature/confirm-descriptors`. All four are missing *behaviour*, not missing copy, which is why none was fixed in that work:
